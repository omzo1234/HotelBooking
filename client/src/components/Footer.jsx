     ...
     <div className='bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                        Decouvre le meilleur des Hotels avec nous. Nous offrons une experience inoubliable pour tous nos clients, avec des offres exclusives et des destinations de rêve.
                    </p>
                    <div className='flex items-center gap-3 mt-4'>
                       ...
                       <img src={assets.instagramIcon} alt="instagram-icon" className='w-6' />
                        ...
                        {/* Twitter */}
                       <img src={assets.twitterIcon} alt="twitter-icon" className='w-6g' />
                        {/* LinkedIn */}
                ...
                <div>
                    <p className='font-playfair text-lg text-gray-800'>OuickSatay</p>
