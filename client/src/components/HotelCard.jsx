...
bg-white text-gray-800 font-medium rounded-full'>Best Seller</p>}
        ...
        <div className='p-4 pt-5'>
            <div className='flex items-center justify-between'>
                <p className='font-plafair text-xl font-medium text-gray-800'>
                    {room.hotel.name} </p>
                     ...
                     <div className='flex items-center gap-2 mt-2'>
                         ...
                         <p className='font-semibold text-gray-800'>{room.hotel.address}</p>
                     </div>
                     <div className='flex items-center justify-between mt-4'>
                        <p><span className='font-semibold text-gray-800'>${room.pricePerNight}</span>/ night</p>
                        <button className='px-4 py-2 text-sm font-medlum border border-gray-300 rounded hover:bg-gray-50 transition-allcursor-pointer'>
                            Book Now</button>
                     </div>
        </div>
